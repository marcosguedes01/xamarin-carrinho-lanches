...
{
    public class BaseViewModel : CompModel.INotifyPropertyChanged
    {
        ...
        public event CompModel.PropertyChangedEventHandler PropertyChanged;
        ...
        public void OnPropertyChanged(string propertyName)
        {
            ...
            PropertyChanged(this, new CompModel.PropertyChangedEventArgs(propertyName));
        }
    }
}
